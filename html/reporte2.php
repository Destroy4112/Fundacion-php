            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Reporte</h4>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                             ...
                             <br><br>
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        $sql = "SELECT * FROM beneficiarios where sede='$sede'";
                                               $result = mysqli_query($conexion, $sql);
                                ...
                                <a href="../metodos/descargaExcel.php" class="btn btn-success"> Descargar</a>
                            </div>                          
                        </div>
                    </div>
                </div>
