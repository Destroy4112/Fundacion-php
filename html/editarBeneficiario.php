                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Registrar Beneficiario</h4><br>
                                    ...
                                    <form action="../metodos/actualizar.php" method="POST">
                                        ...
                                        ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Nombres" value="<?php echo $datos['nombres'] ?>" name="nombres">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Apellidos" value="<?php echo $datos['apellidos'] ?>" name="apellidos">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" placeholder="Cedula" value="<?php echo $datos['cedula'] ?>" name="cedula">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" name="fecha_na" id="fecha-nacimiento" value="<?php echo $datos['fechaNa'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <h6 class="card-title">Fecha expedicion</h6>
                                                            <input type="date" class="form-control" name="fecha_expe" value="<?php echo $datos['fechaExp'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Barrio" name="barrio" value="<?php echo $datos['barrio'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Telefono" name="telefono" value="<?php echo $datos['telefono'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Puntaje SISBEN" name="sisben" value="<?php echo $datos['puntajeSis'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Edad" id="edad" name="edad" value="<?php echo $datos['edad'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control" name="sede">
                                                                ...
                                                                while ($mostrar = mysqli_fetch_array($result)) { ?>
                                                                    <option value="<?php echo $mostrar['Nombre'] ?>" <?php if ($mostrar['Nombre'] == $datos['sede']) {
                                                                                                                            echo ("selected");
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <option selected Disabled>Seleccione la estado</option>
                                                                <?php $sql = "SELECT * FROM estadovul";
                                                                $result = mysqli_query($conexion, $sql);

                                                                while ($mostrar = mysqli_fetch_array($result)) {
                                                                ?>
                                                                    <option value="<?php echo $mostrar['Nombre'] ?>" <?php if ($mostrar['Nombre'] == $datos['estadoVuln']) {
                                                                                                                            echo ("selected");
                                                                                                                        } ?>> <?php echo $mostrar['Nombre'] ?> </option>
                                                                <?php
                                                                }
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <option selected Disabled>Seleccione la eps</option>
                                                                <?php $sql = "SELECT * FROM eps";
                                                                $result = mysqli_query($conexion, $sql);

                                                                while ($mostrar = mysqli_fetch_array($result)) {
                                                                ?>
                                                                    <option value="<?php echo $mostrar['Nombre'] ?>" <?php if ($mostrar['Nombre'] == $datos['eps']) {
                                                                                                                            echo ("selected");
                                                                                                                        } ?>> <?php echo $mostrar['Nombre'] ?> </option>
                                                                <?php
                                                                }
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" placeholder="observacion" name="observacion" value="<?php echo $datos['observaciones'] ?>">
                                                    </div>
                                                </div>
                                            </div>
